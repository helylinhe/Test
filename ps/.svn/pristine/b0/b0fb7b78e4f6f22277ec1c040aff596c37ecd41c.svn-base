...
<html>
	<head>
        ...
        <script src="<%=path%>/js/Highcharts-3.0.9/js/modules/exporting.js"></script>
        	<script type="text/javascript" src="<%=path%>/js/platformManager/interfaceManager/callcenter.js"></script>
        	<script>
	//关闭调阅窗体
	...
	<body>
		<div style="border: 0px; font-size: 12px;" >
				...
				<fieldset style="border: 1px solid #6293BB;">
					...
					<table width="80%">
						<tr>
							...
							<td  align="center">
								<a  class="easyui-linkbutton" icon="icon-save"  onclick="searchLog()">查询</a>
							</td>
						</tr>
					</table>
				</fieldset>
			...
			<div style="width: 95%; margin-left: 10px; margin-top: 5px;">
				<table id="manager_list_tab"></table>
			</div>
