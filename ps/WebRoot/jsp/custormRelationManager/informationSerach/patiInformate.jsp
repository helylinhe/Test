...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=path%>/js/custormRelationManager/informationSerach/patiInformate.js"></script>
		<script language="javascript" type="text/javascript"
	...
	<body>
		...
		<div style="border: 0px; font-size: 12px;width:100%;">
					...
					<table style="width: 100%;">
						...
						<td nowrap="nowrap">
								...
								<select class="easyui-combobox" style="width: 124px;"
									...
									<option value="3">病故</option>
									<option value="4">查无此人</option>
									<option value="5">失访</option>
								</select>
							</td>
			...
			<div
				style="width: 95%; height: 400px; margin-left: 5px; margin-top: 5px;min-width:1100px">
				<div id="blm_grid"></div>
			</div>
			<div
		 ...
		 <div id="jc_html"
				...
				<table style="width:90%; height: 50px; margin-left: 5%;"
					...
					<tr>
					<td style="width: 20%">&nbsp;&nbsp;&nbsp;&nbsp;姓名:<label id="cname"></label></td>
					<td style="width: 20%">病人编号:<label id="cpatiSerial"></label></td>
					<td style="width: 20%">住院流水号:<label id="cinpatiSerialNumber"></label></td>
					</tr>	
				</table>
				
				<div id="jcDiv" style="height: auto;  width: 790px;margin-left: 10px">
        ...
        data-options="iconCls:'',closable:false, border : false,    
			...
			<div id="bl_html"
				...
				<table style="width:90%; height: 50px; margin-left: 5%;"
						cellspacing="0" cellpadding="0">
					<tr>
					<td style="width: 20%">&nbsp;&nbsp;&nbsp;&nbsp;姓名:<label id="bname"></label></td>
					<td style="width: 20%">病人编号:<label id="bpatiSerial"></label></td>
					<td style="width: 20%">住院流水号:<label id="binpatiSerialNumber"></label></td>
					</tr>	
				</table>
