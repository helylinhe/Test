...
<html>
 ...
 <body  topmargin="0" leftmargin="0"> 
  ...
  <!-- 隐藏值 -->
  <input type="hidden" id="history_patiSerial">         
  <input type="hidden" id="history_inpatiNumber">         
  <input type="hidden" id="history_flupNameId">              
  <input type="hidden" id="history_taskId">         
 </body>
</html>
